...
parser.add_argument('--rps', action='store', type=float, default=3,
                    help='RPS')
parser.add_argument('--kp', action='store', type=float, default=2,
...
with open('M10_kp_10times.txt','w') as data:
...
file    = open('M10_kp_10times.txt', 'r')
...
plt.ylabel('Velocity')
plt.xlabel('time - sec')
plt.savefig("M10_kp_10times.png")
...
plt.grid(True)
plt.xlabel("freq - Hz")
plt.savefig("M10_kp_10times_fft.png")
